...
<ul className="navbar-nav d-flex flex-row mt-2 mb-2">
  <li className="mx-1"><span className="mt-2 d-block">{`${Data.fields.created_at}`.slice(8,10)} {month[parseInt(`${Data.fields.created_at}`.slice(5,7))-1]} {`${Data.fields.created_at}`.slice(0,4)}   {tConvert(`${Data.fields.created_at}`.slice(11,16))}</span></li>
</ul>
