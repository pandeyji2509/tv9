...
function Entertainment() {
  ...
  async function fet(){
    const resp=await fetch(
      `${process.env.REACT_APP_Base_Url}show_category_articles/?category=entertainment`
    );
...
<div class="latest-new read-m border-bottom border-2 pb-3">
  ...
  <p>No results to show</p>
            ...
            <div class="col-sm-6">
            <h6 class="text-dark h4 fw-bold display-inline mb-4">
              Entertainment News <i class="bi bi-arrow-right-circle fs-5"></i>
            </h6>
            { 
              newbod.loading ? (
                  <p> Data is fetching.....</p>
...
<div class="latest-new border-bottom border-2 pb-4">
              ...
              <Link to={`/Detailentertainment/${Data.pk}`} class="fw-bold">continue reading</Link>
            </div>
)):(
